    ...
    return (
        <>
            <div className="w-full h-screen flex flex-col lg:flex-row">
                <header class=" lg:w-1/6 lg:h-1/2 mb-8 flex flex-row lg:flex-col items-center justify-between   py-4 md:mb-12 md:py-8 xl:mb-16">
                    ...
                    <nav class=" gap-12 flex flex-row items-center lg:flex-col">
                ...
                <div class="lg:w-5/6 h-full mb-8 overflow-y-scroll flex flex-col items-center justify-between  p-4 md:mb-12 md:py-8 xl:mb-16">
                    <Outlet/>
                </div>
            </div>
        </>
