  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <form class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
      ...
      <div class="sm:col-span-2">
        ...
        <input name="img" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
      </div>

      <div class="sm:col-span-2">
        <label for="header" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">header*</label>
        <input name="header" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
      </div>

      <div class="sm:col-span-2">
        <label for="text" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">text*</label>
        <textarea name="text" class="h-64 w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring"></textarea>
      </div>
